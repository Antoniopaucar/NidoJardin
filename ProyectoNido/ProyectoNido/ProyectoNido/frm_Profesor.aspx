...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <table id="tablaProfesor" class="tablaForm">
     ...
     <tr>
         ...
         <td>
             <asp:TextBox ID="txt_Fecha_Ingreso" runat="server" CssClass="full-width-textbox" TextMode="Date"></asp:TextBox>
         </td>
         <td>&nbsp;</td>
         <td>&nbsp;</td>
     </tr>
     ...
     <tr>
         ...
         <td>
             <asp:Button ID="btn_Modificar" runat="server" Text="MODIFICAR"
                 OnClientClick="return confirm('¿Deseas modificar este Profesor?') && validarCamposTabla('tablaProfesor','txt_Nombres,txt_ApellidoPaterno,txt_ApellidoMaterno,txt_Fecha_Nacimiento,Ddl_Sexo,Ddl_Distrito,txt_Direccion,txt_Telefono,txt_Email,fup_Titulo_Profesional,fup_Cv,fup_Evaluacion_Psicologica,fup_Fotos,fup_Verificacion_Domiciliaria') ;" 
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <div style="width: 40%; margin: 20px auto; text-align: center;">
        ...
        <asp:GridView ID="gvProfesor" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="4"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="EstadoTituloProfesional" HeaderText="Titulo Profesional" />
                <asp:BoundField DataField="EstadoCv" HeaderText="Curriculum Vitae" />
                <asp:BoundField DataField="EstadoEvaluacionPsicologica" HeaderText="Evaluacion Psicologica" />
                <asp:BoundField DataField="EstadoFotos" HeaderText="Fotos" />
                <asp:BoundField DataField="EstadoVerificacionDomiciliaria" HeaderText="Verificacion Domiciliaria" />
