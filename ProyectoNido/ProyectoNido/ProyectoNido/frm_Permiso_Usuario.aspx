<%@ Page Title="" Language="C#" MasterPageFile="~/TemplatePrincipal.Master" AutoEventWireup="true" CodeBehind="frm_Permiso_Usuario.aspx.cs" Inherits="ProyectoNido.frm_Permiso_Usuario" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <table id="tablaUsuarioPermiso" class="tablaForm" >
        <tr class="titulo">
            <td colspan="4">
                <asp:Label ID="Label2" runat="server" Text="Usuario Permiso"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td>
                <asp:Button ID="btn_Agregar" runat="server" Text="AGREGAR" 
                    OnClientClick="return confirm('¿Deseas agregar este Usuario Permiso?') && validarCamposTabla('tablaUsuarioPermiso','');" 
...
<div style="width: 40%; margin: 20px auto; text-align: center;">
     <div style="display: flex; justify-content: center; gap: 10px;">
         <asp:TextBox ID="txtBuscar" runat="server" CssClass="full-width-textbox" placeholder="Buscar por Usuario o Permiso..." />
 ...
 <asp:GridView ID="gvUsuarioPermiso" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="4"
     OnPageIndexChanging="gvUsuarioPermiso_PageIndexChanging"
     OnRowCommand="gvUsuarioPermiso_RowCommand"
        ...
        <asp:TemplateField HeaderText="Acciones">
            <ItemTemplate>
                <asp:Button ID="btnEliminar" runat="server" Text="Eliminar" 
                    ...
                    CommandArgument='<%# Eval("Usuario.Id") + "-" + Eval("Permiso.Id") %>'
                    CssClass="btn btn-peligro btn-sm"
                    OnClientClick="return confirm('¿Deseas eliminar este Usuario Permiso?');" />
            </ItemTemplate>
        </asp:TemplateField>
    </Columns>
 </asp:GridView>
