<%@ Page Title="" Language="C#" MasterPageFile="~/TemplatePrincipal.Master" AutoEventWireup="true" CodeBehind="frm_Rol.aspx.cs" Inherits="ProyectoNido.frm_Rol" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <table id="tablaRol" class="tablaForm" >
        <tr class="titulo">
            <td colspan="4">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txt_IdRol" runat="server" Enabled="false"></asp:TextBox>
            </td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
        ...
        <tr>
            <td>
                <asp:Button ID="btn_Agregar" runat="server" Text="AGREGAR" 
                    OnClientClick="return confirm('¿Deseas agregar este Rol?') && validarCamposTabla('tablaRol','txt_Descripcion');" 
                    OnClick="btn_Agregar_Click" class="btn btn-exito" />
            </td>
            <td>
                <asp:Button ID="btn_Modificar" runat="server" Text="MODIFICAR" 
                    OnClientClick="return confirm('¿Deseas modificar este Rol?') && validarCamposTabla('tablaRol','txt_Descripcion');" 
            ...
            <td>
                <asp:Button ID="btn_Eliminar" runat="server" Text="ELIMINAR" 
                    OnClientClick="return confirm('¿Deseas eliminar este Rol?');"
...
<asp:GridView ID="gvRol" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="4"
